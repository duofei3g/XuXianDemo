#
#  Be sure to run `pod spec lint XuXianDemo.podspec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "duofei"
  # s.authors            = { "duofei" => "duofei3g@163.com" }
  # s.social_media_url   = "http://twitter.com/duofei"
